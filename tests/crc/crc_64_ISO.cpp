...
//}
//
//// Function to compute the CRC64-ISO checksum
//uint64_t crc64_iso(const std::string& data) {
//    uint64_t crc = 0xFFFFFFFFFFFFFFFF; // Initialize CRC to all ones
//
//    for (char byte : data) {
...
//    }
//
//    return crc ^ 0xFFFFFFFFFFFFFFFF; // Final XOR with all ones
//}
//
//// Function to convert CRC64 value to hexadecimal string
//std::string to_hex_string(uint64_t crc) {
//    char buffer[17]; // 16 hex digits + null terminator
//    snprintf(buffer, sizeof(buffer), "%016llx", crc);
//    return std::string(buffer);
//}
//
//void body() {
//    init_crc64_table(); // Initialize the CRC64 table
//    std::string input = "a"; // Input string
//    uint64_t checksum = crc64_iso(input); // Compute checksum
//
//    // Output the result
//    std::cout << "CRC64-ISO for '" << input << "': " << to_hex_string(checksum) << std::endl;
//
//}
...
//        return myCRC64;
//    };
//    unsigned long long calculateCRC64FromChar(char data) {
//        unsigned char byteData[1] = { static_cast<unsigned char>(data) };
//        return calculateCRC64(byteData, 1);
//    }
//
//    void body() {
//
//        char input = 'a'; // Example character
//        unsigned long long crcResult = calculateCRC64FromChar(input);
//        std::cout << "CRC64 of '" << input << "' is: " << std::hex << crcResult << std::endl;
//    }
