...
await runTest([
    '--input=tex_sample_desc_2048.yaml',
    '--method=dfs',
    '--bleeding=1',
    '--bleeding-debug=1',
    `--define=ROOT=${resDir}`,
    '-o',
    `${texturesDir}/tex_sample_dfs_2048.yaml`,
    `${texturesDir}/tex_sample_dfs_2048.png`,
])
...
await runTest([
    ...
    `--define=ROOT=${resDir}`,
    '-o',
    `${texturesDir}/tex_sample_brute_2048.yaml`,
    `${texturesDir}/tex_sample_brute_2048.png`,
])
...
await runTest([
    ...
    `--define=ROOT=${resDir}`,
    '-o',
    `${texturesDir}/tex_sample_rectpack_2048.yaml`,
    `${texturesDir}/tex_sample_rectpack_2048.png`,
])
