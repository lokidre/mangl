...
await runTest([
    '--input=tex_sample_desc_8192.yaml',
    '--method=dfs',
    '--bleeding=1',
    '--bleeding-debug=1',
    `--define=ROOT=${resDir}`,
    '-o',
    `${texturesDir}/tex_sample_dfs_8192.yaml`,
    `${texturesDir}/tex_sample_dfs_8192.png`,
])
...
await runTest([
    ...
    `--define=ROOT=${resDir}`,
    '-o',
    `${texturesDir}/tex_sample_brute_8192.yaml`,
    `${texturesDir}/tex_sample_brute_8192.png`,
])
...
await runTest([
    ...
    `--define=ROOT=${resDir}`,
    '-o',
    `${texturesDir}/tex_sample_rectpack_8192.yaml`,
    `${texturesDir}/tex_sample_rectpack_8192.png`,
])
