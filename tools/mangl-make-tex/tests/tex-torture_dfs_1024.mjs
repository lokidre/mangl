...
await runTest([
    '--input=tex_sample_desc_1024.yaml',
    '--method=dfs',
    '--bleeding=1',
    '--bleeding-debug=1',
    `--define=ROOT=${resDir}`,
    '-o',
    `${texturesDir}/tex_sample_dfs_1024.yaml`,
    `${texturesDir}/tex_sample_dfs_1024.png`,
])
...
await runTest([
    ...
    `--define=ROOT=${resDir}`,
    '-o',
    `${texturesDir}/tex_sample_brute_1024.yaml`,
    `${texturesDir}/tex_sample_brute_1024.png`,
])
...
//     `--define=ROOT=${resDir}`,
//     '-o',
//     `${texturesDir}/tex_sample_rectpack_1024.yaml`,
//     `${texturesDir}/tex_sample_rectpack_1024.png`,
// ])
