...
await runTest([
    '--input=tex_sample_desc_16384.yaml',
    '--method=dfs',
    '--bleeding=1',
    '--bleeding-debug=1',
    `--define=ROOT=${resDir}`,
    '-o',
    `${texturesDir}/tex_sample_dfs_16384.yaml`,
    `${texturesDir}/tex_sample_dfs_16384.png`,
])
...
await runTest([
    ...
    `--define=ROOT=${resDir}`,
    '-o',
    `${texturesDir}/tex_sample_brute_16384.yaml`,
    `${texturesDir}/tex_sample_brute_16384.png`,
])
...
await runTest([
    ...
    `--define=ROOT=${resDir}`,
    '-o',
    `${texturesDir}/tex_sample_rectpack_16384.yaml`,
    `${texturesDir}/tex_sample_rectpack_16384.png`,
])
