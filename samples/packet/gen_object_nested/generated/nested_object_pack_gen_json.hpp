...
inline void pack(const NestedObject& obj, apl::JsonBuilder* builder);
inline void unpack(const apl::Json& packet, NestedObject* obj);

inline auto packStringJson(const NestedObject& obj) {
    apl::JsonBuilder builder;
    pack(obj, &builder);
    return builder.str();
}

inline auto unpackStringJson(std::string_view str, NestedObject* obj) {
    apl::Json packet;
...
inline auto packFileJson(std::string_view filename, const NestedObject& obj) {
    auto str = packStringJson(obj);
    apl::saveFile(filename, str);
}

inline auto unpackFileJson(std::string_view filename, NestedObject* obj) {
        auto str = apl::loadFile(filename);
        unpackStringJson(str, obj);
}



namespace impl_NestedObject_json {
...
inline void packObject(const NestedObject& obj, std::string_view name, apl::JsonBuilder* builder);
inline void unpackObject(const apl::JsonNode& node, NestedObject* obj);

inline void packObject(const SubObject& obj, std::string_view name, apl::JsonBuilder* builder);
inline void unpackObject(const apl::JsonNode& node, SubObject* obj);

inline void packObject(const SubSubObject& obj, std::string_view name, apl::JsonBuilder* builder);
inline void unpackObject(const apl::JsonNode& node, SubSubObject* obj);
...
inline void pack(const NestedObject& obj, apl::JsonBuilder* builder) {
    builder->begin();
    impl_NestedObject_json::packObject(obj, "NestedObject", builder);
    builder->end();
}

inline void unpack(const apl::Json& root, NestedObject* obj) {
    impl_NestedObject_json::clearObject(obj);
    for (auto& docNode: root.front()) {
        impl_NestedObject_json::unpackObject(docNode, obj);
    }
}
