...
inline void pack(const ContainerObject& obj, apl::JsonBuilder* builder);
inline void unpack(const apl::Json& packet, ContainerObject* obj);

inline auto packStringJson(const ContainerObject& obj) {
    apl::JsonBuilder builder;
    pack(obj, &builder);
    return builder.str();
}

inline auto unpackStringJson(std::string_view str, ContainerObject* obj) {
    apl::Json packet;
...
inline auto unpackDataJson(typename apl::DataParam<>::Arg data, ContainerObject* obj) {
    unpackStringJson({(const char *)data.data(), data.size()}, obj);
}



namespace impl_ContainerObject_json {
...
inline void packObject(const ContainerObject& obj, std::string_view name, apl::JsonBuilder* builder);
inline void unpackObject(const apl::JsonNode& node, ContainerObject* obj);

inline void packObject(const ContainerPodValue& obj, std::string_view name, apl::JsonBuilder* builder);
inline void unpackObject(const apl::JsonNode& node, ContainerPodValue* obj);

inline void packObject(const ContainerVectorValue& obj, std::string_view name, apl::JsonBuilder* builder);
inline void unpackObject(const apl::JsonNode& node, ContainerVectorValue* obj);

inline void packObject(const ContainerComplexValue& obj, std::string_view name, apl::JsonBuilder* builder);
inline void unpackObject(const apl::JsonNode& node, ContainerComplexValue* obj);

inline void packObject(const ContainerVectorObjectValue& obj, std::string_view name, apl::JsonBuilder* builder);
inline void unpackObject(const apl::JsonNode& node, ContainerVectorObjectValue* obj);
...
inline void pack(const ContainerObject& obj, apl::JsonBuilder* builder) {
    builder->begin();
    impl_ContainerObject_json::packObject(obj, "ContainerObject", builder);
    builder->end();
}

inline void unpack(const apl::Json& root, ContainerObject* obj) {
    impl_ContainerObject_json::clearObject(obj);
    for (auto& docNode: root.front()) {
        impl_ContainerObject_json::unpackObject(docNode, obj);
    }
}
