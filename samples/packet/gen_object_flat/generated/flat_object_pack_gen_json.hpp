...
inline void pack(const FlatObject& obj, apl::JsonBuilder* builder);
inline void unpack(const apl::Json& packet, FlatObject* obj);

inline auto packStringJson(const FlatObject& obj) {
    apl::JsonBuilder builder;
    pack(obj, &builder);
    return builder.str();
}

inline auto unpackStringJson(std::string_view str, FlatObject* obj) {
    apl::Json packet;
...
inline auto packFileJson(std::string_view filename, const FlatObject& obj) {
    auto str = packStringJson(obj);
    apl::saveFile(filename, str);
}

inline auto unpackFileJson(std::string_view filename, FlatObject* obj) {
...
namespace impl_FlatObject_json {
...
inline void packObject(const FlatObject& obj, std::string_view name, apl::JsonBuilder* builder);
inline void unpackObject(const apl::JsonNode& node, FlatObject* obj);
...
inline void pack(const FlatObject& obj, apl::JsonBuilder* builder) {
    builder->begin();
    impl_FlatObject_json::packObject(obj, "FlatObject", builder);
    builder->end();
}

inline void unpack(const apl::Json& root, FlatObject* obj) {
    impl_FlatObject_json::clearObject(obj);
    for (auto& docNode: root.front()) {
        impl_FlatObject_json::unpackObject(docNode, obj);
    }
}
