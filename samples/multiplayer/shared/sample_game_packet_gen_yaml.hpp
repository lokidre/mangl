...
inline void pack(const SampleGamePacket& obj, apl::YamlBuilder* builder);
inline void unpack(const apl::Yaml& packet, SampleGamePacket* obj);

inline auto packStringYaml(const SampleGamePacket& obj) {
    apl::YamlBuilder builder;
    pack(obj, &builder);
    return builder.str();
}

inline auto unpackStringYaml(std::string_view str, SampleGamePacket* obj) {
    apl::Yaml packet;
...
inline auto unpackDataYaml(DataParamA data, SampleGamePacket* obj) {
    unpackStringYaml({(const char *)data.data(), data.size()}, obj);
}



namespace impl_SampleGamePacket_yaml {
...
inline void packObject(const SampleGamePacket& obj, std::string_view name, apl::YamlBuilder* builder);
inline void unpackObject(const apl::YamlNode& node, SampleGamePacket* obj);

inline void packObject(const mmp::MpPacketPlayer& obj, std::string_view name, apl::YamlBuilder* builder);
inline void unpackObject(const apl::YamlNode& node, mmp::MpPacketPlayer* obj);

inline void packObject(const mmp::MpPacketElement& obj, std::string_view name, apl::YamlBuilder* builder);
inline void unpackObject(const apl::YamlNode& node, mmp::MpPacketElement* obj);

inline void packObject(const Point& obj, std::string_view name, apl::YamlBuilder* builder);
inline void unpackObject(const apl::YamlNode& node, Point* obj);

inline void packObject(const PointI& obj, std::string_view name, apl::YamlBuilder* builder);
inline void unpackObject(const apl::YamlNode& node, PointI* obj);

inline void packObject(const Size& obj, std::string_view name, apl::YamlBuilder* builder);
inline void unpackObject(const apl::YamlNode& node, Size* obj);
...
inline void packObject(const Rect& obj, std::string_view name, apl::YamlBuilder* builder);
inline void unpackObject(const apl::YamlNode& node, Rect* obj);

inline void packObject(const RectI& obj, std::string_view name, apl::YamlBuilder* builder);
inline void unpackObject(const apl::YamlNode& node, RectI* obj);
...
inline void pack(const SampleGamePacket& obj, apl::YamlBuilder* builder) {
    builder->begin();
    impl_SampleGamePacket_yaml::packObject(obj, "SampleGamePacket", builder);
    builder->end();
}

inline void unpack(const apl::Yaml& root, SampleGamePacket* obj) {
    impl_SampleGamePacket_yaml::clearObject(obj);
    for (auto& docNode: root.front()) {
        impl_SampleGamePacket_yaml::unpackObject(docNode, obj);
    }
}
